...
namespace Speedtest
{
    public partial class BBLTest : Form
    {
        ...
        public BBLTest()
        {
            ...
            Icon = Icon.FromHandle(Properties.Resources.speedometer.GetHicon());
        ...
        private void RunSpeedTest()
        {
            ...
            if (!Stopping)
            {
                ...
                {
                    File.WriteAllBytes(excelfilepath, Properties.Resources.Status);
                }
            ...
            try
            {
                ...
                if (ControlSettings.AutoStart)
                {
                    if (!File.Exists(path))
                    {
                        ...
                        windowsApplicationShortcut.Description = "Speedtest from Brasil Banda Larga";
